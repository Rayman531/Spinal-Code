...
optotrak_data = dlmread('L3_B_Injured_LateralBending_3d.csv', ',', 5, 0);
...
lvm_data = dlmread('L3_B_Injured_LateralBending.lvm');
time_lvm = lvm_data(:, 8);  
...
figure;
hold on;
plot(My_interp(1,555:1090), alpha_deg(555:1090,1), 'r', 'LineWidth', 1.5);
xlabel('Moment [Nm]');
ylabel('\alpha Angle [°]');
