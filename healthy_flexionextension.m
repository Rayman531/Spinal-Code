...
optotrak_data = dlmread('L3_B_Healthy_FlexionExtension_3d.csv', ',', 5, 0);
...
lvm_data = dlmread('L3_B_Healthy_FlexionExtension.lvm');
time_lvm = lvm_data(:, 8);  
...
figure;
hold on;
plot(My_interp(1,1200:1800), beta_deg(1200:1800,1), 'r', 'LineWidth', 1.5);
xlabel('Moment [Nm]');
ylabel('\beta Angle [°]');
